...
export type Combo1Query = { __typename?: 'Query', accounts: Array<{ __typename?: 'Account', address: string, balance: string }>, contracts: Array<{ __typename?: 'Account', address: string, balance: string }>, transactions: Array<{ __typename?: 'Transaction', hash: string, block: { __typename?: 'Block', number: string, timestamp: number } } | null>, blocks: Array<{ __typename?: 'Block', number: string, timestamp: number } | null> };
...
export type ContractQuery = { __typename?: 'Query', contract?: { __typename?: 'Account', address: string, balance: string, transactions: Array<{ __typename?: 'Transaction', hash: string, nonce: number, from: string } | null> } | null };
