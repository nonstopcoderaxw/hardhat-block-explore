...
export interface MyErc20Interface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "sendETH", values?: undefined): string;
...
export interface MyErc20 extends BaseContract {
  ...
  callStatic: {
    ...
    sendETH(overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    ReceivedETH(from?: null, ethAmt?: null): ReceivedETHEventFilter;
