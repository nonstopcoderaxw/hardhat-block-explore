...
const HardhatNodeServices_1 = require("./datasources/HardhatNodeServices");
const localPlugin = {};
        ...
        context: async () => {
            return {
                dataSources: {
                    ...
                    hardhatNodeServices: new HardhatNodeServices_1.HardhatNodeServices(process.env.NODE_ENDPOINT)
                },
            };
        },
